...
// Inject the renderer via dependency injection (autofac nuget pckg)
...
// Here the bridging happens.
// Build a bridge between the Shape and who ever is drawing it (in this case the IRenderer).
// We do it via constructor injection.
