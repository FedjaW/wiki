...
// // The adapter pattern is conforming an interface that you are given to an interface that you already have.
...
// // Problem: We are given VectorObject but we can only draw points.
